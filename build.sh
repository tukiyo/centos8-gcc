...
#$BUILD Dockerfile.centos8-gcc494 -t tukiyo/centos8-gcc:centos8-gcc494
#$BUILD Dockerfile.centos8-gcc550 -t tukiyo/centos8-gcc:centos8-gcc550

$BUILD Dockerfile.centos8-compatgcc -t tukiyo/centos8-gcc:centos8-compatgcc
